...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if User.currentUser != nil {
            ...
            let mentionsNavController = UINavigationController(rootViewController: mentionsVC)
            
            let vc = storyboard.instantiateViewControllerWithIdentifier("ContainerViewController") as! ContainerViewController
            vc.tweetsViewController = homeNavController
            vc.profileViewController = profileNavController
            vc.mentionsViewController = mentionsNavController
